...
short test1()
{
  ...
  if ( !lock ) 
  {
    kDebug( 5970 ) <<"test1(): failed to lock" << icalfilename;
    rval = 1;
  }
  ...
  if ( !rval )
  {
    ...
    if ( thread.gotlock() )
    {
      kDebug( 5970 ) <<"test1(): second thread was able to lock" << icalfilename;
      rval = 1;
    }
  }
...
short test2()
{
  ...
  if ( !thread.gotlock() )
  {
    kDebug(5970) <<"test2(): second thread was not able to lock" << icalfilename;
    rval = 1;
  }
...
short test3()
{
  ...
  if ( !rval )
  {
    ...
    if ( !thread.gotlock() )
    {
      kDebug( 5970 ) <<"test1(): second thread was not able to lock" << icalfilename;
      rval = 1;
    }
  }
